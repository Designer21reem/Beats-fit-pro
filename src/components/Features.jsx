...
const Features = () => {
  ...
  const images = ["./src/assets/f1.png", "./src/assets/f2.png", "./src/assets/f3.png", "./src/assets/f4.png"];
  ...
  return (
    <section ref={ref} className="overflow-hidden flex items-center justify-center mt-[600px]">
      {/* left side */}
      <img className="absolute left-0 w-[635px] h-[508px]" src="./src/assets/s1.png" alt="" />
